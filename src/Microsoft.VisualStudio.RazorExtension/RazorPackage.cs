...
namespace Microsoft.VisualStudio.RazorExtension
{
    ...
    [ProvideToolWindow(typeof(Microsoft.VisualStudio.RazorExtension.RazorInfoToolWindow))]
    public sealed class RazorPackage : Package
    {
        ...
        protected override void Initialize()
        {
            ...
            Microsoft.VisualStudio.RazorExtension.RazorInfoToolWindowCommand.Initialize(this);
        }
    }
}
